...
function Create() {
    ...
    const inputTypes = ["Name", "Questions"]
    ...
    return (
        <div>
            <h1 className="heading">Create new live event form</h1>

            <div className="form">
                <div className="input">
                    <label>Event Name</label>
                    <input type="text" placeholder="Enter event" onChange={e => updateObjState(setFormModel, formModel, "title", e.target.value)} />
                </div>

                <div className="input">
                    <label>Description</label>
                    <input type="text" placeholder="Enter short description of live event" onChange={e => updateObjState(setFormModel, formModel, "endMessage", e.target.value)} />
                </div>
